                ...
                <div class="col-12">
                    <div class="table-content table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = _customerOngoingOrders(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td class="product-subtotal"><a href="<?php echo e(route('frontend.allOngoingOrderCarts', $order)); ?>" class="btn os-btn">View</a></td>
                            </tr>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pigstuhq/pureoproducts.pigslhub.com/resources/views/frontend/orders/allOngoingOrders.blade.php ENDPATH**/ ?>