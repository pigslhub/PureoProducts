                                        ...
                                        <li>
                                            ...
                                            <div class="cart-content f-left text-left">
                                                ...
                                                <div class="cart-price">
                                                    ...
                                                    <span class="price">$<?php echo e($cart->price); ?></span><br>
                                                    <?php if($cart->qty < 6): ?>
                                                        <span class="price"><b>Total : $<?php echo e($cart->qty * $cart->product->price); ?></b></span>
                                                    <?php else: ?>
                                                        <span class="price"><b>Total : $<?php echo e($cart->qty * $cart->product->wholesalePrice); ?></b></span>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        </li>
...
<!-- header area end -->
<?php /**PATH C:\Users\shiza\Desktop\SirImran\PureoProducts\resources\views/frontend/includes/partials/header.blade.php ENDPATH**/ ?>