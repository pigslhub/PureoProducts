                            ...
                            <table class="display" id="basic-1">
                                ...
                                <?php $__currentLoopData = $onGoingOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $orders): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($orders->driver ==null ? '---': $orders->driver->name); ?></td>
                                        <td><?php echo e($orders->amount); ?></td>
                                        <td><?php echo e($orders->due_date); ?></td>
                                        <td><?php echo e($orders->due_time); ?></td>
                                        <td>
                    ...
                    <div class="card-body">  
                        <div class="table-responsive">
                            <table class="display" id="basic-2">
                                ...
                                <tbody>
                                <?php $__currentLoopData = $readyOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $orders): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($loop->iteration); ?></td>
                                        <td><?php echo e($orders->order_id); ?></td>
                                        <td><?php echo e($orders->customer ==null ? '---': $orders->customer->name); ?></td>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pigstuhq/pureoproducts.pigslhub.com/resources/views/admin/orders/viewEarning.blade.php ENDPATH**/ ?>
