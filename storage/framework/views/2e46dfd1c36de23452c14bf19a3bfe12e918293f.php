            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="basic-login">
                        ...
                        <form class="theme-form" method="post" id="login-form" action="<?php echo e(route('customer.login.submit')); ?>">
                            <?php echo csrf_field(); ?>
                            <div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <a href="<?php echo e(route('customer.register')); ?>" class="os-btn os-btn-black w-100">Register Now</a>
                        </form>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pigstuhq/pureoproducts.pigslhub.com/resources/views/customer/auth/userLogin.blade.php ENDPATH**/ ?>