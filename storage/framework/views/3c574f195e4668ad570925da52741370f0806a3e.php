                ...
                <div class="card-body">
                    ...
                    <?php echo csrf_field(); ?>
                        ...
                        <input type="hidden" value="<?php echo e(isset($adminProduct) ? $adminProduct->sub_category_id : $sub_category_id); ?>" name="sub_category_id">
                            <div class="col-md-6">
                                <label for="product_name" class="col-form-label"><?php echo e(__('Product Name')); ?></label>
                                <input type="text" name="name" id="name" class="form-control"
                                value="<?php echo e(isset($adminProduct) ? $adminProduct->name : ''); ?>">
                            </div>
                            <div class="col-md-6">
                                <label for="product_name" class="col-form-label"><?php echo e(__('Price')); ?></label>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pigstuhq/pureoproducts.pigslhub.com/resources/views/admin/product/create.blade.php ENDPATH**/ ?>