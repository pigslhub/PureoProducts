                                ...
                                <?php $__currentLoopData = _getAllProducts(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <form action="<?php echo e(route('carts.store')); ?>" method="POST">
                                        ...
                                        <tr>
                                            ...
                                            <input type="hidden" name="in_stock" value="<?php echo e($product->in_stock); ?>">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\shiza\Desktop\SirImran\PureoProducts\resources\views/admin/dashboardPos.blade.php ENDPATH**/ ?>