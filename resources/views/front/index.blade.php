...
<html class="no-js" lang="zxx">
    <head>
        @include('front.includes.partials.head')
        @include('front.includes.partials.style')
        <style>
    ...
    <body>
        ...
        <!-- prealoder area end -->
        <!-- header area start -->
        @include('front.includes.partials.header')
        ...
        <main id="home">
                ...
                <section class="slider__area slider__area-3 p-relative">
                    <div class="slider-active">
                        <div class="single-slider single-slider-2 slider__height-5 d-flex align-items-center" data-background="{{asset('front/img/slider/slider-1.jpg')}}">
                        ...
                        <div class="single-slider single-slider-2 slider__height-5 d-flex align-items-center" data-background="{{asset('front/img/slider/slider-2.jpg')}}">
                            <div class="container-fluid">
                                <div class="row">
                        ...
                        <div class="single-slider single-slider-2 slider__height-5 d-flex align-items-center" data-background="{{asset('front/img/slider/slider-3.jpg')}}">
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-xl-6 col-lg-6 col-md-10 opactiyWhiteColorWithPadding">
                                        <div class="slider__content slider__content-3 pl-250">
                                ...
                                <div class="row">
                                    ...
                                    <div id="wowslider-container1">
                                        <div class="ws_images"><ul>
                                            <li><img src="{{asset('assets/data1/images/one.png')}}" alt="one" title="One Click Receipt's Printing" id="wows1_2"/></li>
                                            <li><img src="{{asset('assets/data1/images/two.png')}}" alt="two" title="One Click Business Switching" id="wows1_4"/></li>
                                            <li><img src="{{asset('assets/data1/images/three.png')}}" alt="html slider" title="All Major Business Categories Provided" id="wows1_3"/></li>
                                            <li><img src="{{asset('assets/data1/images/four.png')}}" alt="four" title="One Click Load Products From Our Database" id="wows1_1"/></li>
                                                <li><img src="{{asset('assets/data1/images/five.png')}}" alt="five" title="Create Advertisement To Boost Your Sales" id="wows1_0"/></li>
                                            </ul></div>
                                            <div class="ws_bullets"><div>
                                                <a href="#" title="five"><span><img src="{{asset('assets/data1/tooltips/five.png')}}" alt="five"/>1</span></a>
                                                <a href="#" title="four"><span><img src="{{asset('assets/data1/tooltips/four.png')}}" alt="four"/>2</span></a>
                                                <a href="#" title="one"><span><img src="{{asset('assets/data1/tooltips/one.png')}}" alt="one"/>3</span></a>
                                                <a href="#" title="three"><span><img src="{{asset('assets/data1/tooltips/three.png')}}" alt="three"/>4</span></a>
                                                <a href="#" title="two"><span><img src="{{asset('assets/data1/tooltips/two.png')}}" alt="two"/>5</span></a>
                                            </div></div>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row no-gutters">
                                <div class="col-xl-6 col-lg-6">
                                    <div class="banner__item-2 banner-right p-relative mb-30 pr-15">
                                        <div class="banner__thumb fix">
                                            <a href="index.html" class="w-img"><img src="{{asset('front/img/shop/banner/banner-big-4.jpg')}}" alt="banner"></a>
                                        </div>
                                ...
                                <div class="col-xl-6 col-lg-6">
                                    <div class="banner__item-2 banner-right p-relative mb-30 pr-15">
                                        <div class="banner__thumb fix">
                                            <a href="index.html" class="w-img"><img src="{{asset('front/img/shop/banner/banner-big-1.jpg')}}" alt="banner"></a>
                                        </div>
                                ...
                                <div class="col-xl-6 col-lg-6">
                                    <div class="banner__item-2 banner-right p-relative mb-30 pr-15">
                                        <div class="banner__thumb fix">
                                            <a class="w-img">
                                                <img src="{{asset('front/img/shop/banner/banner-big-2.jpg')}}" alt="banner">
                                            </a>
                                        </div>
                                ...
                                <div class="col-xl-6 col-lg-6">
                                    <div class="banner__item-2 banner-right p-relative mb-30 pr-15">
                                        <div class="banner__thumb fix">
                                            <a href="index.html" class="w-img"><img src="{{asset('front/img/shop/banner/banner-big-3.jpg')}}" alt="banner"></a>
                                        </div>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row no-gutters">
                                <div class="col-xl-4 col-lg-4">
                                    <div class="banner__item-2 banner-right p-relative mb-30 pr-15">
                                        <div class="banner__thumb fix">
                                            <a href="index.html" class="w-img"><img src="{{asset('front/img/shop/stakeholder/customer.jpg')}}" alt="banner"></a>
                                        </div>
...
{{--                                            <h4 style="color: #FFFFFF">Customers</h4>--}}
{{--                                            <a href="index.html" class="os-btn os-btn-2">Start Selling</a>--}}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-4 col-lg-4">
                                    <div class="banner__item-2 banner-right p-relative mb-30 pr-15">
                                        <div class="banner__thumb fix">
                                            <a href="index.html" class="w-img"><img src="{{asset('front/img/shop/stakeholder/driver.jpg')}}" alt="banner"></a>
                                        </div>
...
{{--                                            <h4 style="color: #FFFFFF">Driver</h4>--}}
{{--                                            <a href="index.html" class="os-btn os-btn-2">Start Selling</a>--}}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-4 col-lg-4">
                                    <div class="banner__item-2 banner-right p-relative mb-30 pr-15">
                                        <div class="banner__thumb fix">
                                            <a class="w-img">
                                                <img src="{{asset('front/img/shop/stakeholder/shop.jpg')}}" alt="banner">
                                            </a>
                                        </div>
...
{{--                            </div>--}}
        ...
        <!-- footer area end -->
        <!-- JS here -->
        @include('front.includes.partials.scripts')
    </body>
</html>
