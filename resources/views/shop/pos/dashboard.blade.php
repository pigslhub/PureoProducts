                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($orders->has_cart == 1)
                                                <button value="{{$orders->id}}" order_id="{{$orders->order_id}}"
                                            ...
                                            @else
                                                ...
                                                <button value="{{$orders->id}}" order_id="{{$orders->order_id}}"
                                                        ...
                                                        class="btn-show-products btn btn-sm btn-danger"><i
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        @foreach (_getAllCategoriesForShopTypeId() as $category)
                            <button class="btn btn-large btn-category btn-success m-2"
                ...
                <div class="card shadow-lg">
                    <div class="card-body" id="divToPrint">
                        <div class="text-center">
                            <img src="{{_getShopAvatar(auth('shop')->user()->id)}}"
                                 style="background-size:cover;height:100px;width:100px" id="reciptImage"/>
                            <div>
                                <p style='font-size:12px' id=receiptAddress><i style='font-size:12px'
                                                                               class='fa fa-map-marker'></i></i>&nbsp;&nbsp;{{auth('shop')->user()->address}}
                                    <br></p>
                                <p style='font-size:12px' id="receiptPhone"><i style='font-size:12px'
                                                                               class="fa fa-phone"></i>&nbsp;&nbsp;{{auth('shop')->user()->phone}}
                                </p>
                            </div>
                        </div>
                        <hr class="hr1">
                ...
                switch ($(this).attr('btnfor')) {
                    ...
                    case "add":
                        ...
                        $.ajax({
                            ...
                            method: "POST",
                            data: {
                                "order_id": orderidForadd,
                                "customer_id": customeridForadd,
                                "product_id": productidforadd,
                                "price": priceforadd,
                                "qty": 1,
                                "total": priceforadd,
                                "purchased": 1,
                    ...
                    case "remove":
                        ...
                        $.ajax({
                            ...
                            method: "POST",
                            data: {
                                "order_id": orderidForRemove,
                                "customer_id": customeridForRemove,
                                "product_id": productidforremove,
                                "price": priceforremove,
                                "qty": 1,
                                "purchased": 1,
                                "action": "remove"
                            },
