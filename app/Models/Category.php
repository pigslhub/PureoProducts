...
//
    ...
    public function getIconPath($size = 'sm')
    {
        ...
        return asset('storage/categories/icons/' . $this->id . '-' . $sizes[$size] . '.png');
        else
    ...
    public function updateIcon()
    {
        if (request()->hasFile('icon')) {
            ...
            if ($image->width() > $image->height()) {
                ...
                $this->update(['icon' => "/categories/icons/{$this->id}-100x75.png"]);
                ...
                $this->update(['icon' => "/categories/icons/{$this->id}-100x100.png"]);
            } else {
                ...
                $this->update(['icon' => "/categories/icons/{$this->id}-50x75.png"]);
            }
